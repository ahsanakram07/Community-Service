    ...
    <div id="right-panel" class="right-panel">
		        ...
		        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		            ...
		            <div class="row form-group">
		                ...
		                <div class="col-12 col-md-9">
		                    <input type="text" id="text-input" name="name" placeholder="Driver Name" class="form-control" required="">
		                </div>
		            </div>
		            ...
		            <div class="row form-group">
		                ...
		                <div class="col-12 col-md-9">
		                    <textarea name="address" id="textarea-input" rows="5" placeholder="Driver Address..." class="form-control" required=""></textarea>
		                </div>
		            </div>
		...
		<?php
			...
			if(isset($_POST['add']) && array_key_exists("name",$_POST))
			{
				...
				$sql="INSERT INTO driver(Full_Name,Image,Gender,Address,Mobile_No,Email,Admin_ID) VALUES ('$name','$image','$gender','$address','$mobile','$email','$admin')";

				$row=mysqli_query($connection,$sql);

				$target="images/driver/".basename($_FILES['pic']['name']);
