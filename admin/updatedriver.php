    ...
    <div id="right-panel" class="right-panel">
		        ...
		        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		        	...
		        	<div class="row form-group">
		                ...
		                <div class="col-12 col-md-9">
		                    <input type="text" id="text-input" name="name" placeholder="Driver Name" class="form-control" value="<?php echo $row['Full_Name'] ?>">
		                </div>
		            </div>
		            ...
		            <div class="row form-group">
		                ...
		                <div class="col-12 col-md-9">
		                    <textarea name="address" id="textarea-input" rows="5" placeholder="Driver Address..." class="form-control"><?php echo $row['Address']; ?></textarea>
		                </div>
		            </div>
		...
		if(isset($_POST['update']) && array_key_exists("name",$_POST))
		{
			...
			if($_FILES['pic']['name'] != "")
			{
				...
				$sql4="UPDATE driver SET Full_Name='$name',Image='$image',Gender='$gender',Address='$address',Mobile_No='$mobile',Email='$email',Admin_ID='$admin' WHERE Driver_ID='$id'";

				$row4=mysqli_query($connection2,$sql4);

				$target2="images/driver/".basename($_FILES['pic']['name']);
			...
			{
				$sql2="UPDATE driver SET Full_Name='$name',Gender='$gender',Address='$address',Mobile_No='$mobile',Email='$email',Admin_ID='$admin' WHERE Driver_ID='$id'";
