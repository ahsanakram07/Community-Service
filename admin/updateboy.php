<?php include("header.php"); ?>
    ...
    <div id="right-panel" class="right-panel">
	            ...
	            <div class="page-header float-right">
	                <div class="page-title">
	                    <ol class="breadcrumb text-right">
	                        ...
	                        <li class="active">Update Boys School</li>
	                    </ol>
	                </div>
	            </div>
	        </div>
		...
		$sql="SELECT * FROM boys_school WHERE BS_ID = '$id'";
		...
		<div class="card">
		    <div class="card-header">
		        <strong>Update</strong> Boys School
		    </div>
		        ...
		        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		        	...
		        	<div class="row form-group">
		                ...
		                <div class="col-12 col-md-9">
		                    <input type="text" id="text-input" name="name" placeholder="Boy School Name" class="form-control" value="<?php echo $row['Full_Name'] ?>">
		                </div>
		            </div>
		...
		if(isset($_POST['update']) && array_key_exists("name",$_POST))
		{
			...
			$sql2="UPDATE boys_school SET Full_Name='$name',People_Catagory='$catagory',Entry_Time='$entry',Exit_Time='$exit',Admin_ID='$admin' WHERE BS_ID='$id'";
