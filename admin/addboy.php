    ...
    <div id="right-panel" class="right-panel">
	            ...
	            <div class="page-header float-right">
	                <div class="page-title">
	                    <ol class="breadcrumb text-right">
	                        ...
	                        <li class="active">Add Boys School</li>
	                    </ol>
	                </div>
	            </div>
	        </div>
		        ...
		        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		            ...
		            <div class="row form-group">
		                ...
		                <div class="col-12 col-md-9">
		                    <input type="text" id="text-input" name="name" placeholder="Boy School Name" class="form-control" required="">
		                </div>
		            </div>
		...
		<?php
			...
			if(isset($_POST['add']) && array_key_exists("name",$_POST))
			{
				...
				$sql="INSERT INTO boys_school(Full_Name,People_Catagory,Entry_Time,Exit_Time,Admin_ID) VALUES ('$name','$catagory','$entry','$exit','$admin')";
